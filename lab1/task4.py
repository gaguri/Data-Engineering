...
# Чтение файла
df = pd.read_csv('lab1/files/fourth_task.txt')
...
df_filtered.to_csv('lab1/files/results/task4_1.csv', index=False, header=True)

# Сохранение результатов вычислений
with open("lab1/files/results/task4_2.txt", "w") as file:
